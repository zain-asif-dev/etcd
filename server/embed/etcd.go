...
func StartEtcd(inCfg *Config) (e *Etcd, err error) {
	...
	srvcfg := config.ServerConfig{
		...
		AdmissionControlEnabled:           cfg.AdmissionControlEnabled,
		AdmissionControlDryRun:            cfg.AdmissionControlDryRun,
		RateLimitReads:                    cfg.RateLimitReads,
		RateLimitWrites:                   cfg.RateLimitWrites,
		RateLimitBurstFactor:              cfg.RateLimitBurstFactor,
